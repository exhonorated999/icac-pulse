 ...
 *
 * Renders embedded inside the Case Information card on the Overview tab —
 * a divider + sub-heading + 2-column grid of inputs. No own panel wrapper.
 *
 * Each metric input matches its type:
